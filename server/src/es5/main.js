  ...
  n.g = function () {
    ...
    var a,
      ...
      function e(t) {
        ...
        }), n = !0, 1 !== t.nodeType && (n = !1, console.log("is not Element node.")), !n || "CANVAS" !== t.nodeName) throw "Error ! 잘못된 데이터 타입 입니다.";
        var n;
    ...
    I.addEventListener("click", R), P.addEventListener("click", function t(e) {
      M.isEmpty() ? alert("지역을 선택해주세요.") : (e.target.classList.remove("roulette__button--activated"), e.target.removeEventListener("click", t), I.removeEventListener("click", R), M.setSpin(), M.setTime(), setTimeout(function () {
